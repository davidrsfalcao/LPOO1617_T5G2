...
public class GamePanel extends JPanel {
	...
	public GamePanel() {	
		 ...
		 */
		try {
			hero_front = ImageIO.read(new File("src/dkeep/gui/res/hero/Hero.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			hero_back = ImageIO.read(new File("src/dkeep/gui/res/hero/HeroBack.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			heroArmed_back = ImageIO.read(new File("src/dkeep/gui/res/hero/HeroBackArmed.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			heroArmed_front = ImageIO.read(new File("src/dkeep/gui/res/hero/HeroArmed.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			heroKeyArmed_front = ImageIO.read(new File("src/dkeep/gui/res/hero/HeroArmedWithKey.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			 club = ImageIO.read(new File("src/dkeep/gui/res/ogre/Club.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		 ...
		 */
		try {
			ogre_front = ImageIO.read(new File("src/dkeep/gui/res/ogre/Ogre.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			ogre_back = ImageIO.read(new File("src/dkeep/gui/res/ogre/OgreBack.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			ogreStunned_front = ImageIO.read(new File("src/dkeep/gui/res/ogre/OgreStunned.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			wall00 = ImageIO.read(new File("src/dkeep/gui/res/walls/Wall00.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			wall01 = ImageIO.read(new File("src/dkeep/gui/res/walls/Wall01.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			wall02 = ImageIO.read(new File("src/dkeep/gui/res/walls/Wall02.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			wall03 = ImageIO.read(new File("src/dkeep/gui/res/walls/Wall03.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
				
		try {
			wall06 = ImageIO.read(new File("src/dkeep/gui/res/walls/Wall06.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			wall07 = ImageIO.read(new File("src/dkeep/gui/res/walls/Wall07.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			wallC = ImageIO.read(new File("src/dkeep/gui/res/walls/WallC.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			wallC1 = ImageIO.read(new File("src/dkeep/gui/res/walls/WallC1.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		 ...
		 */
		try {
			guard_front = ImageIO.read(new File("src/dkeep/gui/res/guard/Guard.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			guard_back = ImageIO.read(new File("src/dkeep/gui/res/guard/GuardB.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			guard_sleep = ImageIO.read(new File("src/dkeep/gui/res/guard/GuardS.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			floor = ImageIO.read(new File("src/dkeep/gui/res/floor/Grass.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			floors = ImageIO.read(new File("src/dkeep/gui/res/floor/Grass1.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			doorClosed = ImageIO.read(new File("src/dkeep/gui/res/objectives/Closed.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			key = ImageIO.read(new File("src/dkeep/gui/res/objectives/Key.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			leverUp = ImageIO.read(new File("src/dkeep/gui/res/objectives/Lever.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			leverDown = ImageIO.read(new File("src/dkeep/gui/res/objectives/Lever1.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			lose_img = ImageIO.read(new File("src/dkeep/gui/res/Lose.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			win_img = ImageIO.read(new File("src/dkeep/gui/res/Win.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			light1 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_01.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light2 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_02.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light3 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_03.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light4 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_04.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light5 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_05.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light6 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_06.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light7 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_07.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light8 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_08.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		try {
			light9 = ImageIO.read(new File("src/dkeep/gui/res/luz/Luz_09.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
